...
Podemos aplicar estos operadores a vectores para encontrar valores que satisfagan algún criterio. Por ejemplo, dado un vector, podemos buscar cuáles de sus elementos son menores a `10` (recuerda dar clic en la palabra `Code` para mostrar el código R):
