...
Guardamos la escena como `playground.tscn` y ya tenemos la configuración inicial de nuestro *metroidvania* lista. En una entrada posterior comenzaremos con el personaje principal, mecánicas básicas y sus configuraciones iniciales.
