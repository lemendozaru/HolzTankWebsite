...
Vamos a cargar en R un marco de datos que ya viene con su instalación: `mtcars`. Basta con escribir su nombre (recuerda dar clic en la palabra `Code` para mostrar el código R):
