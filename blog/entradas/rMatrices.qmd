...
Construyamos una matriz con nueve elementos dispuestos en tres filas. R sabrá que debe rellenar por filas si se lo decimos con `byrow=T` (recuerda dar clic en la palabra `Code` para mostrar el código R).
